...
const AdminNavbar = () => {
  ...
  const getLinkClass = (path: string) => {
    ...
    return `flex items-center gap-2 text-sm font-bold uppercase tracking-wide transition-all duration-200 ${
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center gap-12">
            <Link href="/admin" aria-label="Admin Home" className="shrink-0 group">
                <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          {user ? (
            <div className="flex items-center gap-3 bg-gray-50 pl-4 pr-2 py-1.5 rounded-full border border-gray-100">
               <div className="hidden sm:flex flex-col items-end leading-none mr-2">
                  <span className="text-[10px] text-[#69995D] uppercase font-bold tracking-wider">Admin</span>
